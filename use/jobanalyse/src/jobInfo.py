#########################################################################
# File Name: jobInfo.py
# Author: wolf
# mail: wolfguidao@163.com
# Created Time: 2020年08月11日 星期二 09时25分18秒
#########################################################################
...
class JobInfo(object):
    ...
    def run(self):
        ...
        if os.path.exists(self.path):
            ...
            with open(os.path.join(self.path, '招聘_关键词_{}_城市_{}.csv'.format(self.keyword, self.city)), 'w',
...
if __name__ == '__main__':
    ...
    if os.path.exists(downloadpath):
        ...
        if keyword != None and city!=None:
            JobInfo(city=city, keyword=keyword).run()
